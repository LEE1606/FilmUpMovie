...
{
	public class ShowTimeManagerAuthorizationHandler : AuthorizationHandler<OperationAuthorizationRequirement, ShowTime>
	{
		protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, OperationAuthorizationRequirement requirement, ShowTime resource)
		{
			...
			if (context.User.IsInRole(Constants.ShowTimeManagersRole))
			{
