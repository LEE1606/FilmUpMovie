...
{
	public class ShowRoomManagerAuthorizationHandler : AuthorizationHandler<OperationAuthorizationRequirement, ShowRoom>
	{
		protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, OperationAuthorizationRequirement requirement, ShowRoom resource)
		{
			...
			if (context.User.IsInRole(Constants.ShowRoomManagersRole))
			{
